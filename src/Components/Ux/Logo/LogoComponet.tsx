...
export function LogoComponet() {
  return (
      ...
      <div className="flex flex-col items-center bg-colorButton2  p-4 rounded-3xl overflow-hidden">
        <img alt="logo" src={Logo} className="max-w-28 object-cover" />
        <h1 className="font-family-[var(--fontSubTitulo)] font-[var(--weightSubTitulo)] text-white " style={{fontSize:"var(--sizeTexto", textWrap:"nowrap"}}>
